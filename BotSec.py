...
st.title("Security Bot")
st.write("Write your query below:")

# SageMaker endpoint URL
SAGEMAKER_ENDPOINT = "https://runtime.sagemaker.us-east-1.amazonaws.com/endpoints/meta-textgeneration-llama-2-7b-f-2023-09-04-19-49-48-116/invocations"

messages = [
    {"role": "system", "content": "You are an AWS Security Administrator."},
]
